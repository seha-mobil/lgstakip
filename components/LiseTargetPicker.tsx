...
const topSchools = [
  { name: 'İstanbul Erkek Lisesi', puan: 500.00 },
  { name: 'Galatasaray Lisesi', puan: 500.00 },
  { name: 'Kabataş Erkek Lisesi', puan: 500.00 },
  { name: 'Atatürk Fen Lisesi', puan: 493.96 },
  { name: 'Cağaloğlu Anadolu Lisesi', puan: 493.96 },
  { name: 'Hüseyin Avni Sözen AL', puan: 489.02 },
  { name: 'Beşiktaş Sakıp Sabancı AL', puan: 486.22 },
  { name: 'Kadıköy Anadolu Lisesi', puan: 485.28 },
  { name: 'Haydarpaşa Lisesi', puan: 482.98 },
  { name: 'Validebağ Fen Lisesi', puan: 477.21 },
  { name: 'Burak Bora Anadolu Lisesi', puan: 477.63 },
  { name: 'Y.İ. Alanyalı Fen Lisesi', puan: 466.10 },
  { name: 'Kartal Anadolu Lisesi', puan: 460.00 },
  { name: 'Ş. İlhan Varank Fen Lisesi', puan: 461.51 },
  { name: 'Kartal Köy Hizmetleri AL', puan: 452.05 },
  { name: 'İstanbul Anadolu Lisesi', puan: 459.06 },
  { name: 'Hacı Sabancı Anadolu Lisesi', puan: 434.13 },
];
